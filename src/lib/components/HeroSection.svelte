<section id="hero" class="grid min-h-screen grid-cols-1 gap-10 md:grid-cols-2">
	...
	<div class="hidden sm:flex flex-col justify-center items-center">
		<svg viewBox="110 110 283 283" xmlns="http://www.w3.org/2000/svg" class="mx-10 xl:max-h-[70vh]">
			...
			<g transform="matrix(1, 0, 0, 1, -19.99999971823263, 89.99999873204655)" id="node2-1">
				<path
			...
			<g transform="matrix(1, 0, 0, 1, -139.99999802762818, 209.99999704144204)" id="node1-2">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
			...
			<g transform="matrix(1, 0, 0, 1, -19.99999971823263, 209.99999704144204)" id="node2-2">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
			...
			<g transform="matrix(1, 0, 0, 1, 99.99999859116292, 209.99999704144204)" id="node3-2">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
			...
			<g transform="matrix(1, 0, 0, 1, 99.99999859116292, 89.99999873204655)" id="node3-1">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
			...
			<g transform="matrix(1, 0, 0, 1, -19.99999971823263, 330.0000258684151)" id="node2-3">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
			...
			<g transform="matrix(1, 0, 0, 1, -140.00001328641702, 329.9999953508375)" id="node1-3">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
			...
			<g transform="matrix(1, 0, 0, 1, 99.99999859116292, 329.9999953508375)" id="node3-3">
				<path
					d="M 263 23 L 283 23 C 288.523 23 293 27.477 293 33 L 293 53 C 293 58.523 288.523 63 283 63 L 263 63 C 257.477 63 253 58.523 253 53 L 253 33 C 253 27.477 257.477 23 263 23 Z"
					style="fill: rgb(106, 0, 177);"
				/>
...
<style>
	...
	#node2-3-c {
		animation-name: threeflashes;
		animation-duration: 5000ms;
		animation-delay: 10s;
		animation-iteration-count: infinite;
	}

	@keyframes twoflashes {
		0% {
			fill: rgb(255, 235, 0);
		}
		5% {
